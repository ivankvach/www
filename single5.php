...
<html>
<head>
<title>Ексклюзивний і авторський одяг | плаття-сорочка космос :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single5/s5.jpg">
								<div class="thumb-image"> <img src="imagessingle/single5/s5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single5/s5.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single5/s5.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single5/s5.2.jpg">
							<div class="thumb-image"> <img src="imagessingle/single5/s5.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single5/s5.3.jpg">
							<div class="thumb-image"> <img src="imagessingle/single5/s5.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
							<li data-thumb="imagessingle/single5/s5.4.jpg">
							<div class="thumb-image"> <img src="imagessingle/single5/s5.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
							<li data-thumb="imagessingle/single5/s5.5.jpg">
								<div class="thumb-image"> <img src="imagessingle/single5/s5.5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
							<li data-thumb="imagessingle/single5/s5.6.jpg">
								<div class="thumb-image"> <img src="imagessingle/single5/s5.6.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
							<li data-thumb="imagessingle/single5/s5.7.jpg">
								<div class="thumb-image"> <img src="imagessingle/single5/s5.7.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
							<li data-thumb="imagessingle/single5/s5.8.jpg">
								<div class="thumb-image"> <img src="imagessingle/single5/s5.8.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
						</ul>
					</div>
										  <video controls>
                              <source src="imagessingle/single5/v5.mp4" type="video/mp4">
                                    </video>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Плаття-сорочка Космос</h3>
						<span>1300 ГРН.</span>
						<div class="clearfix"></div>
						<p>Плаття справді космічне. Зливається з світлом. Клітинка,широкий рукав і 9 гудзиків. Тут бракує тільки шлему і полетіли.</p>
						<p></p>
					</div>
					<div class="span span1">
						<p class="left">Матеріал:</p>
						<p class="right">шерсть середньої плотності</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=5" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Плаття досить легке. Класичний крій. Підійде любій фігурі і під любі мешти. Просто стильно. "Стильно так просто"-Їжак.</p>    
        </div>
			...
			<header>
				<h3 class="like text-center">Схожа Продукція</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						...
						<p><a class="item_add" href="single8.php"><span class="item_price">1400 грн.</span></a></p>
					</div>
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single6.php"><img src="images/s6.2.jpg" alt="" /></a>
						<a class="product_name" href="single6.php">вінтажне,темно-бірюзове плаття</a>
						<p><a class="item_add" href="single6.php"><span class="item_price">2500 грн.</span></a></p>
					</div>
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single9.php"><img src="images/s9.jpg" alt="" /></a>
						<a class="product_name" href="single9.php">плаття з пониженою талією</a>
						<p><a class="item_add" href="single9.php"><span class="item_price">2000 грн.</span></a></p>
					</div>
					<div class="clearfix"></div>
				   </div>
				   </div>
