...
<html>
<head>
<title>Ексклюзивний і авторський одяг | плаття з пониженою талією :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single9/s9.jpg">
								<div class="thumb-image"> <img src="imagessingle/single9/s9.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single9/s9.3.jpg">
								<div class="thumb-image"> <img src="imagessingle/single9/s9.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single9/s9.5.jpg">
								<div class="thumb-image"> <img src="imagessingle/single9/s9.5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single9/s9.6.jpg">
								<div class="thumb-image"> <img src="imagessingle/single9/s9.6.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single9/s9.9.jpg">
								<div class="thumb-image"> <img src="imagessingle/single9/s9.9.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
						</ul>
					</div>
										  <video controls>
                              <source src="imagessingle/single9/v9.mp4" type="video/mp4">
                                    </video>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Плаття з пониженою талією</h3>
						<span>2000 ГРН.</span>
						<div class="clearfix"></div>
						<p>О_о наше favorito. Легке як пір'їнка. Воно справді Їжакове. Елегантне і водночас трішки зухвале.</p>
						<p></p>
					</div>
					<div class="span span1">
						<p class="left">Матеріал:</p>
						<p class="right">Трикотаж-вафля: віскоза-93%, лайкра-7%</p>
						<div class="clearfix"></div>
					</div>
					<div class="span span2">
						<p class="left">Довжина:</p>
						<p class="right">Довге</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=9" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Ніжно сірий колір. Благородне. Понижена талія виглядає дуже неординарно.Красиве.</p>    
        </div>
			...
			<header>
				<h3 class="like text-center">Схожа Продукція</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single8.php"><img src="images/s8.4.jpg" alt="" /></a>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single6.php"><img src="images/s6.6.jpg" alt="" /></a>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single9.php"><img src="images/s9.4.jpg" alt="" /></a>
