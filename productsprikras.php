...
<html>
<head>
<title>Ексклюзивний і авторський одяг | прикраси :: izhak.com.ua</title>
			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Прикраси</span>&nbsp;</li>
					</ul>
				...
				<div class="mens-toolbar">
					...
					<ul>
					  <li>
							<a class="cbp-vm-image" href="single11.php">
							 ...
							 <div class="view view-first">
								...
								<div class="product_image">
									...
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Етно намисто з монетами</p>
										 <p class="title1">900 грн</p>
									   </div>									   
									   <div class="clearfix"></div>
								     </div>		
								  </div>
							...
							<form action="zapisi_tovara.php?idtovara=11" method="POST">
							  <input type="submit" value="В корзину">
							   </form>
							   </div>
						</li>
						<li>
							<a class="cbp-vm-image" href="single12.php">
								<div class="simpleCart_shelfItem">
							  <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									...
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Етно браслет з монетами</p>
										 <p class="title1">320 грн</p>
									   </div>
									    <div class="clearfix"></div>
								     </div>		
								  </div>
							 ...
							 <form action="zapisi_tovara.php?idtovara=12" method="POST">
							  <input type="submit" value="В корзину">
							   </form>
							</div>
						</li>
						<li>
							<a class="cbp-vm-image" href="single13.php">
								<div class="simpleCart_shelfItem">
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="images/s13.jpg" class="img-responsive" alt=""/>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Намисто з розового агату</p>
										 <p class="title1">950 грн</p>
									   </div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
							...
							<form action="zapisi_tovara.php?idtovara=13" method="POST">
							  <input type="submit" value="В корзину">
							   </form>
							</div>
						</li>
						<li>
							<a class="cbp-vm-image" href="single14.php">
								<div class="simpleCart_shelfItem">
							  <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="images/s14.jpg" class="img-responsive" alt=""/>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Брошка листок</p>
										 <p class="title1">250 грн</p>
									   </div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
							 ...
							 <form action="zapisi_tovara.php?idtovara=14" method="POST">
							  <input type="submit" value="В корзину">
							   </form>
							</div>
						</li>
						<li>
							<a class="cbp-vm-image" href="single15.php">
								<div class="simpleCart_shelfItem">
							  <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="images/s15.jpg" class="img-responsive" alt=""/>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Сережки кольорові</p>
										 <p class="title1">200 грн</p>
									   </div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
							 ...
							 <form action="zapisi_tovara.php?idtovara=15" method="POST">
							  <input type="submit" value="В корзину">
							   </form>
							</div>
						</li>
						<li>
							<a class="cbp-vm-image" href="single16.php">
								<div class="simpleCart_shelfItem">
							  <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="images/s16.jpg" class="img-responsive" alt=""/>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Брошка їжачок</p>
										 <p class="title1">150 грн</p>
									   </div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
							 ...
							 <form action="zapisi_tovara.php?idtovara=16" method="POST">
							  <input type="submit" value="В корзину">
							   </form>
							</div>
						</li>
