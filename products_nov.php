...
<html>
<head>
<title>Ексклюзивний і авторський одяг | Новинки :: izhak.com.ua</title>
			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Новинки</span>&nbsp;</li>
					</ul>
					...
					<ul>
						<li>
							...
							<div class="cbp-vm-details">
								Намисто з натурального агату,світло-зеленого кольору.З скляними вставками і бронзовою фурнітурою.Етно стиль.
							</div>
						...
						<li>
							...
							<div class="cbp-vm-details">
								Браслет з натурального агату,світло-зеленого кольору з бронзовими і скляними вставками.Етно стиль.
							</div>
   ...
   <!-- content-section-ends -->
		...
		<div class="container">
			<h3 class="like text-center">Популярна колекція</h3>        			
				     <ul id="flexiselDemo3">
						<li><a href="single2.php"><img src="images/s2.jpg" class="img-responsive"/></a>
