...
<html>
<head>
<title>Ексклюзивний і авторський одяг | сорочка caramel :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single10/s10.jpg">
								<div class="thumb-image"> <img src="imagessingle/single10/s10.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single10/s10.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single10/s10.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single10/s10.2.jpg">
								<div class="thumb-image"> <img src="imagessingle/single10/s10.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single10/s10.3.jpg">
								<div class="thumb-image"> <img src="imagessingle/single10/s10.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single10/s10.5.jpg">
								<div class="thumb-image"> <img src="imagessingle/single10/s10.5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
						</ul>
						</div>
											  <video controls>
                              <source src="imagessingle/single10/v10.mp4" type="video/mp4">
                                    </video>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Сорочка Caramel</h3>
						<span>800 ГРН.</span>
						<div class="clearfix"></div>
						<p>Вона дуже широка. Асиметрична. Має кишеню. Якщо ти любиш щось чудернацьке, тоді ця сорочка для тебе. Ідеально підходить для гри в хованки в пустелі. Тебе ніхто не знайде.</p>
						<p></p>
					</div>
					...
					<div class="span span2">
						...
						<p class="right">80 см по довжині спини</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=10" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Кольору піску. Підходить для,будь якої, фігури. Асиметричність сорочки надає їй родзинку.</p>    
        </div>
