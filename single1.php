...
<html>
<head>
<title>Ексклюзивний і авторський одяг | сорочка deep blue :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single1/s1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single1/s1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single1/s1.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single1/s1.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single1/s1.2.jpg">
							<div class="thumb-image"> <img src="imagessingle/single1/s1.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single1/s1.3.jpg">
							<div class="thumb-image"> <img src="imagessingle/single1/s1.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single1/s1.4.jpg">
							<div class="thumb-image"> <img src="imagessingle/single1/s1.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single1/s0.jpg">
							<div class="thumb-image"> <img src="imagessingle/single1/s0.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
						</ul>
					</div>
					  <video controls>
                              <source src="imagessingle/single1/v1.mp4" type="video/mp4">
                                    </video>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Сорочка deep blue</h3>
						<span>850 ГРН.</span>
						<div class="clearfix"></div>
						<p>Ми придумали додати до цієї сорочки етно тасьму. Пасує. Сорочка без витребеньок. Просто і це саме те що любить Їжак.</p>
						<p></p>
					</div>
					<div class="span span1">
						<p class="left">Матеріал:</p>
						<p class="right">Бавовна</p>
						<div class="clearfix"></div>
					</div>
					<div class="span span2">
						<p class="left">Довжина:</p>
						<p class="right">71 см по спині, 61 см рукав</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="span span6">
						...
						<p class="right">на рукаві етно тасьма, ширина 4 см</p>
						<div class="clearfix"></div>
					</div>
					<div class="purchase">
						<a href="#"></a>
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=1" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Сорочка фіолетово-голубого відтінку. Підійде як під класичну спідницю так і під кльошові штани. Рукав на резинці. Зручний варіант для тих хто завжди літає.))) </p>    
        </div>
