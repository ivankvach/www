...
<html>
<head>
<title>Екслюзивний і авторський одяг | зелене намисто :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single11/s11.jpg">
								<div class="thumb-image"> <img src="imagessingle/single11/s11.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single11/s11.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single11/s11.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single11/s11.2.jpg">
								<div class="thumb-image"> <img src="imagessingle/single11/s11.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single11/s11.3.jpg">
								<div class="thumb-image"> <img src="imagessingle/single11/s11.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single11/s11.5.jpg">
								<div class="thumb-image"> <img src="imagessingle/single11/s11.5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
						</ul>
						</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Етно намисто з монетами</h3>
						<span>950 ГРН.</span>
						<div class="clearfix"></div>
						<p>Намисто з натурального агату,світло-зеленого кольору.З скляними вставками і бронзовою фурнітурою.Етно стиль. </p>
						<p></p>
					</div>
					...
					<div class="span span4">
						...
						<p class="right">нижньої нитки-67 см,верхньої-60 см</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=11" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Намисто з натурального агату,світло-зеленого кольору.З скляними вставками і бронзовою фурнітурою.Етно стиль. </p>    
        </div>
