...
<html>
<head>
<title>Ексклюзивний і авторський одяг | розове намисто :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single13/s13.jpg">
								<div class="thumb-image"> <img src="imagessingle/single13/s13.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single13/s13.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single13/s13.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single13/s13.2.jpg">
								<div class="thumb-image"> <img src="imagessingle/single13/s13.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single13/s13.3.jpg">
								<div class="thumb-image"> <img src="imagessingle/single13/s13.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single13/s13.4.jpg">
								<div class="thumb-image"> <img src="imagessingle/single13/s13.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
						</ul>
						</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Намисто з розового агату</h3>
						<span>950 ГРН.</span>
						<div class="clearfix"></div>
						<p>Намисто з натурального агату,світло-рожевого кольору. З скляними намистинами і фурнітурою під срібло.Намисто дуже ніжне і делікатне.</p>
						<p></p>
					</div>
					<div class="span span1">
						<p class="left">Матеріал:</p>
						<p class="right">натуральне каміння,агат</p>
						<div class="clearfix"></div>
					</div>
					<div class="span span4">
						<p class="left">Довжина:</p>
						<p class="right">по нижній нитці 62 см,по верхній 51 см</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=13" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Намисто з натурального агату,світло-рожевого кольору. З скляними намистинами і фурнітурою під срібло.Намисто дуже ніжне і делікатне.</p>    
        </div>
			...
			<header>
				<h3 class="like text-center">Схожа Продукція</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						...
						<p><a class="item_add" href="single14.php"><span class="item_price">220 грн.</span></a></p>
					</div>
					<div class="col-md-4 product simpleCart_shelfItem text-center">
