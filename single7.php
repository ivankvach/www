...
<html>
<head>
<title>Ексклюзивний і авторський одяг | плаття голуба крапля :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single7/s7.jpg">
								<div class="thumb-image"> <img src="imagessingle/single7/s7.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single7/s7.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single7/s7.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single7/s7.2.jpg">
							<div class="thumb-image"> <img src="imagessingle/single7/s7.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single7/s7.3.jpg">
							<div class="thumb-image"> <img src="imagessingle/single7/s7.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single7/s7.4.jpg">
							<div class="thumb-image"> <img src="imagessingle/single7/s7.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single7/s7.5.jpg">
							<div class="thumb-image"> <img src="imagessingle/single7/s7.5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single7/s7.6.jpg">
							<div class="thumb-image"> <img src="imagessingle/single7/s7.6.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 							
						</ul>
					</div>
										  <video controls>
                              <source src="imagessingle/single7/v7.mp4" type="video/mp4">
                                    </video>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Плаття голуба крапля</h3>
						<span>1500 ГРН.</span>
						<div class="clearfix"></div>
						<p>З цим платтям можна добре поексперементувати. Воно, справді, класичне, але має родзинку. І це ти. Будь обрежною, в цьому платті ти неперевершена. Тобі сподобається.</p>
						<p></p>
					</div>
					<div class="span span1">
						<p class="left">Матеріал:</p>
						<p class="right">напівшерсть</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=7" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text"> Плаття прямого крою із завуженим низом. Має легкий сіро-голубий відтінок. Гарно дивиться з яскравими кольорами і будь-яким взуттям. Як з поясом так і без.</p>    
        </div>
		...
		<div class="container">
			<header>
				<h3 class="like text-center">Схожа Продукція</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single2.php"><img src="images/s2.6.jpg" alt="" /></a>
						<a class="product_name" href="single2.php">жилетка з вінтажними гудзиками</a>
						<p><a class="item_add" href="single2.php"><span class="item_price">875 грн.</span></a></p>
					</div>
					<div class="col-md-4 product simpleCart_shelfItem text-center">
