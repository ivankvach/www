...
?>
			            ...
			            <div class="row">
				            <div class="col-sm-4">
					            <ul class="multi-column-dropdown">
						            ...
						            <li><a href="products_tun.php">ТУНІКИ</a></li>
						            <li><a href="products_sor.php">СОРОЧКИ</a></li>
						            <li><a href="products_szhak.php">ЖАКЕТИ</a></li>
									<li><a href="products_spidn.php">СПІДНИЦІ</a></li>
					            </ul>
				            </div>
							<div class="clearfix"></div>
			            </div>
			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Спідниці</span>&nbsp;</li>
					</ul>
					...
					<ul>
					  <li>
							...
							<form action="zapisi_tovara.php?idtovara=1" method="POST">
							  <input type="submit" value="В корзину" onClick="alert('Товар добавлений в корзину!')">
							   </form>
							   </div>
						</li>
						<li>
   ...
   <!-- content-section-ends -->
			...
			<h3 class="like text-center">Популярна колекція</h3>        			
				     <ul id="flexiselDemo3">
						<li><a href="single7.php"><img src="images/s7.jpg" class="img-responsive"/></a>
							...
							<a class="like_name" href="single7.php">Perfectly simple</a>
							<p><a class="item_k" href="#"><i></i></a><span class="price">759 грн</span></p>
							</div>
						</li>
						<li><a href="single8.php"><img src="images/s8.jpg" class="img-responsive"/></a>						
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single8.php">Praising pain</a>
							<p><a class="item_k" href="#"><i></i></a><span class="price">699 грн</span></p>
							</div>
						</li>
						<li><a href="single9.php"><img src="images/s9.jpg" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single9.php">Neque porro</a>
							<p><a class="item_k" href="#"><i></i></a><span class="price">329 грн</span></p>
							</div>
						</li>
						<li><a href="single10.php"><img src="images/s10.jpg" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single10.php">Equal blame</a>
							<p><a class="item_k" href="#"><i></i></a><span class="price">499 грн</span></p>
							</div>
						</li>
						<li><a href="single6.php"><img src="images/s6.jpg" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single6.php">Perfectly simple</a>
							<p><a class="item_k" href="#"><i></i></a><span class="price">649 грн</span></p>
							</div>
						</li>
				     </ul>
		...
		<div class="news-letter">
			<div class="container">
				<div class="join">
					<h6>БРЕНДОВИЙ ОДЯГ ЇЖАК.COM.UA</h6>
					<div class="clearfix"> </div>
				</div>
			</div>
		</div>
