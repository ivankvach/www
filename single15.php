...
<html>
<head>
<title>Ексклюзивний і авторський одяг | сережки кольорові :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single15/s15.jpg">
								<div class="thumb-image"> <img src="imagessingle/single15/s15.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single15/s15.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single15/s15.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single15/s15.2.jpg">
								<div class="thumb-image"> <img src="imagessingle/single15/s15.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single15/s15.3.jpg">
								<div class="thumb-image"> <img src="imagessingle/single15/s15.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single15/s15.4.jpg">
								<div class="thumb-image"> <img src="imagessingle/single15/s15.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
						</ul>
						</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Сережки кольорові</h3>
						<span>200 грн.</span>
						<div class="clearfix"></div>
						<p>Кольорові.Веселі.Піднімуть тобі настрій.</p>
						<p></p>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=15" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Кольорові.Веселі.Піднімуть тобі настрій.</p>    
        </div>
		...
		<div class="container">
			<header>
				<h3 class="like text-center">Схожа Продукція</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single16.php"><img src="images/s16.jpg" alt="" /></a>
						<a class="product_name" href="single16.php">брошка їжачок</a>
						<p><a class="item_add" href="single16.php"><span class="item_price">150 грн.</span></a></p>
					</div>
					<div class="col-md-4 product simpleCart_shelfItem text-center">
