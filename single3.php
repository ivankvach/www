...
<html>
<head>
<title>Ексклюзивний і авторський одяг | костюм.жилетка+спідниця :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single3/s3.jpg">
								<div class="thumb-image"> <img src="imagessingle/single3/s3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single3/s3.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single3/s3.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single3/s3.2.jpg">
							    <div class="thumb-image"> <img src="imagessingle/single3/s3.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single3/s3.3.jpg">
								<div class="thumb-image"> <img src="imagessingle/single3/s3.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single3/s3.4.jpg">
								<div class="thumb-image"> <img src="imagessingle/single3/s3.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single3/s3.5.jpg">
								<div class="thumb-image"> <img src="imagessingle/single3/s3.5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single3/s3.6.jpg">
								<div class="thumb-image"> <img src="imagessingle/single3/s3.6.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single3/s3.7.jpg">
								<div class="thumb-image"> <img src="imagessingle/single3/s3.7.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
						</ul>
					</div>
					 <video controls>
                             <source src="imagessingle/single3/v3.mp4" type="video/mp4">
                     </video>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Костюм. Жилетка+спідниця</h3>
						<span>1450 ГРН.</span>
						<div class="clearfix"></div>
						<p>Класично-некласичний костюм. Тканина не гладка,а має фактурні чорні вкраплення. Або з каблуками і в офіс або...з черевиками і на танці. Єхуу</p>
						<p> </p>
					</div>
					<div class="span span1">
						<p class="left">Матеріал:</p>
						<p class="right">шерсть</p>
						<div class="clearfix"></div>
					</div>
					<div class="span span2">
						<p class="left">Довжина:</p>
						<p class="right">жилетка-65 см, спідниця-79 см</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="span span4">
						<p class="left">Параметри моделі:</p>
						<p class="right">Ріст-170, 86-68-91</p>
						<div class="clearfix"></div>
					</div>
					<div class="span span5">
						<p class="left">Виробник:</p>
						<p class="right">Україна</p>
						<div class="clearfix"></div>
					</div>
					<div class="span span6">
						<p class="left">Деталі:</p>
						<p class="right">має підкладку(костюм+спідниця)</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=3" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text"> Цікавий синій колір. Костюм досить тонкий,має підкладку золотого кольору. Спідниця-олівець з високою талією. Оптимальна довжина міді. Жилетка прямого крою без застібки. Сюди гарно підійде яскравий пояс. </p>    
        </div>
			...
			<header>
				<h3 class="like text-center">Схожа Продукція</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single10.php"><img src="images/s10.5.jpg" alt="" /></a>
						<a class="product_name" href="single10.php">сорочка caramel</a>
						<p><a class="item_add" href="single10.php"><span class="item_price">800 грн.</span></a></p>
					</div>
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single4.php"><img src="images/s4.4.jpg" alt="" /></a>
						<a class="product_name" href="single4.php">Темно-сірий шерстяний костюм</a>
						<p><a class="item_add" href="single4.php"><span class="item_price">1600 грн.</span></a></p>
					</div>
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single1.php"><img src="images/s1.jpg" alt="" /></a>
						<a class="product_name" href="single1.php">сорочка deep blue</a>
						<p><a class="item_add" href="single1.php"><span class="item_price">850 грн.</span></a></p>
					</div>
					<div class="clearfix"></div>
				   </div>
				   </div>
