...
<html>
<head>
<title>Ексклюзивний і авторський одяг | вінтажне,темно-бірюзове плаття :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single6/s6.jpg">
								<div class="thumb-image"> <img src="imagessingle/single6/s6.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single6/s6.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single6/s6.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single6/s6.2.jpg">
							<div class="thumb-image"> <img src="imagessingle/single6/s6.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single6/s6.3.jpg">
							<div class="thumb-image"> <img src="imagessingle/single6/s6.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single6/s6.4.jpg">
							<div class="thumb-image"> <img src="imagessingle/single6/s6.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single6/s6.6.jpg">
							<div class="thumb-image"> <img src="imagessingle/single6/s6.6.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single6/s6.9.jpg">
							<div class="thumb-image"> <img src="imagessingle/single6/s6.9.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single6/s6.10.jpg">
							<div class="thumb-image"> <img src="imagessingle/single6/s6.10.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
						</ul>
					</div>
										  <video controls>
                              <source src="imagessingle/single6/v6.mp4" type="video/mp4">
                                    </video>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Вінтажне, темно-бірюзове плаття</h3>
						<span>2500 ГРН.</span>
						<div class="clearfix"></div>
						<p>Улюблене плаття Їжака. Для леді з характером. Плаття з важкої тканини. Ти точно будеш ловити усмішки і компліменти.</p>
						<p></p>
					</div>
					<div class="span span1">
						<p class="left">Матеріал:</p>
						<p class="right">Трикотаж: бавовна-20%, поліестер-80%</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=6" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Плаття з об'ємним рукавом на манжеті. Плаття вільного крою. Теплий осінньо-зимово-весняний варіант))) Нереальний колір. Ну справді такого в природі не існує.</p>    
        </div>
		...
		<div class="container">
			<header>
				<h3 class="like text-center">Схожа Продукція</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single1.php"><img src="images/s5.2.jpg" alt="" /></a>
						<a class="product_name" href="single1.php">плаття-сорочка космос</a>
						<p><a class="item_add" href="single1.php"><span class="item_price">1300 грн.</span></a></p>
					</div>
					<div class="col-md-4 product simpleCart_shelfItem text-center">
