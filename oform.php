...
<html>
<head>
<title>Ексклюзивний і авторський одяг | Оформлення :: izhak.com.ua</title>
<link href="css/bootstrap.css" rel='stylesheet' type='text/css' />
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="js/jquery.min.js"></script>
<!-- Custom Theme files -->
<link href="css/style.css" rel="stylesheet" type="text/css" media="all" />
<link href="css/styleoform.css" rel="stylesheet" type="text/css" media="all" />
<!-- Custom Theme files -->
...
?>
	...
	<div class="cart-items">
	  <div class="container">
	    <div class="table0"> 
	      <div class="table1">
		  		<h1 align="center">Ваше замовлення</h1> 
...
$OrderTotal = $OrderTotal + $rezulitat;
  ...
  echo "<tr>
    <td align='center'>$id_tovara</td>
        <td><img src='foto/$id_tovara.jpg' align='center' alt='product' height='318' width='180' border='0'></td>
    <td>$opisanie</td>
...
<tr bgcolor="#f5d7bf">
    ...
    <td colspan="2" align="" style="border-style:solid"><b><?php echo number_format($OrderTotal,2) ?> грн.</b></td>
</tr>
</table></div><br><br>
...
<div class="table2">
 <h1 align="center">Оформити замовлення</h1>
<form onSubmit = "return checkform(this)" action="final.php?summa=<?php echo $OrderTotal; ?>" method="post">
<table align="center">
<tr>
<td><span class="head4">ПІП</span><font color="red">*</font></td>
<td><input type="text" name="ФИО" size="40" required></td>
</tr>
<tr>
<td><span class="head4">Телефон</span><font color="red">*</font></td>
<td><script src="js/jquery.maskedinput.min.js"></script><input type="text" placeholder="Телефон" class="phone_mask" name="телефон" size="40" required><script>$(".phone_mask").mask("+38(999)999-99-99");</script></td>
</tr>
<tr>
...
<tr>
<td><span class="head4">Адреса</span></td>
<td><textarea name="adres" cols="40" rows="4">Київ</textarea></td>
</tr>
<tr>
<td><span class="head4">Коментарії</span></td>
<td><textarea name="Ком" cols="40" rows="3"></textarea></td>
</tr>
<tr>
<td> </td>
