...
<html>
<head>
<title>Ексклюзивний і авторський одяг | зелений браслет :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single12/s12.jpg">
								<div class="thumb-image"> <img src="imagessingle/single12/s12.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single12/s12.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single12/s12.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single12/s12.2.jpg">
								<div class="thumb-image"> <img src="imagessingle/single12/s12.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single12/s12.3.jpg">
								<div class="thumb-image"> <img src="imagessingle/single12/s12.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single12/s12.4.jpg">
								<div class="thumb-image"> <img src="imagessingle/single12/s12.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>						
						</ul>
						</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Етно браслет з монетами</h3>
						<span>320 ГРН.</span>
						<div class="clearfix"></div>
						<p>Браслет з натурального агату,світло-зеленого кольору з бронзовими і скляними вставками.Етно стиль.</p>
						<p></p>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=12" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Браслет з натурального агату,світло-зеленого кольору з бронзовими і скляними вставками.Етно стиль.Довжину при потребі можна вкоротити.</p>    
        </div>
