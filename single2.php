...
<html>
<head>
<title>Ексклюзивний і авторський одяг | жилетка з вінтажними гудзиками :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single2/s2.jpg">
								<div class="thumb-image"> <img src="imagessingle/single2/s2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single2/s2.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single2/s2.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single2/s2.2.jpg">
							<div class="thumb-image"> <img src="imagessingle/single2/s2.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single2/s2.3.jpg">
								<div class="thumb-image"> <img src="imagessingle/single2/s2.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single2/s2.4.jpg">
								<div class="thumb-image"> <img src="imagessingle/single2/s2.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single2/s2.5.jpg">
								<div class="thumb-image"> <img src="imagessingle/single2/s2.5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single2/s2.6.jpg">
								<div class="thumb-image"> <img src="imagessingle/single2/s2.6.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
						</ul>
					</div>
					 <video controls>
                              <source src="imagessingle/single2/v2.mp4" type="video/mp4">
                                    </video>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Жилетка з вінтажними гудзиками</h3>
						<span>875 грн.</span>
						<div class="clearfix"></div>
						<p>Жилетка прямого крою. Просто підходить до всього. Просто підходить тобі. Вінтажні гудзики,а хочеш просто гудзики.</p>
						<p></p>
					</div>
					<div class="span span1">
						<p class="left">Матеріал:</p>
						<p class="right">напівшерсть середньої плотності</p>
						<div class="clearfix"></div>
					</div>
					<div class="span span2">
						<p class="left">Довжина:</p>
						<p class="right">60 см по спині</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="span span5">
						...
						<div class="clearfix"></div>
					</div><div class="span span6">
						<p class="left">Деталі:</p>
						<p class="right">має підкладку</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=2" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Двубортна жилетка прямого крою,в чорно-сіру полоску. Має світло-сіру підкладку в тон полоски. З платтям,штанами чи без. Класно дивиться як доповнення або як самостійний наряд. </p>    
        </div>
			...
			<header>
				<h3 class="like text-center">Схожа Продукція</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single3.php"><img src="images/s3.1.jpg" alt="" /></a>
