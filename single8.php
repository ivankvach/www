...
<html>
<head>
<title>Ексклюзивний і авторський одяг | шоколадне плаття в діагональну полоску :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single8/s8.jpg">
								<div class="thumb-image"> <img src="imagessingle/single8/s8.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single8/s8.3.jpg">
								<div class="thumb-image"> <img src="imagessingle/single8/s8.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single8/s8.4.jpg">
								<div class="thumb-image"> <img src="imagessingle/single8/s8.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single8/s8.5.jpg">
								<div class="thumb-image"> <img src="imagessingle/single8/s8.5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single8/s8.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single8/s8.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single8/s8.2.jpg">
								<div class="thumb-image"> <img src="imagessingle/single8/s8.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
						</ul>
					</div>
										  <video controls>
                              <source src="imagessingle/single8/v8.mp4" type="video/mp4">
                                    </video>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Шоколадне плаття в діагональну полоску</h3>
						<span>1400 ГРН.</span>
						<div class="clearfix"></div>
						<p>Відчуваю себе в цьому платті бешкетницею. Для неординарних образів. Дуже жіночне і ніжне.</p>
						<p></p>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=8" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Мягке і приємне на дотик. Полоска діагональна. В цьому і фішка. А скільки всього можна покласти в кишені. Побешкетуємо? </p>    
        </div>
		...
		<div class="container">
			<header>
				<h3 class="like text-center">Схожа Продукція</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single7.php"><img src="images/s7.5.jpg" alt="" /></a>
						<a class="product_name" href="single7.php">плаття голуба крапля</a>
						<p><a class="item_add" href="single7.php"><span class="item_price">1500 грн.</span></a></p>
					</div>
					<div class="clearfix"></div>
				   </div>
				   </div>
