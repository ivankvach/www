...
<html>
<head>
<title>Ексклюзивний і авторський одяг | темно-сірий шерстяний костюм :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single4/s4.jpg">
								<div class="thumb-image"> <img src="imagessingle/single4/s4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single4/s4.1.jpg">
							<div class="thumb-image"> <img src="imagessingle/single4/s4.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single4/s4.2.jpg">
							<div class="thumb-image"> <img src="imagessingle/single4/s4.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single4/s4.3.jpg">
							<div class="thumb-image"> <img src="imagessingle/single4/s4.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single4/s4.4.jpg">
							<div class="thumb-image"> <img src="imagessingle/single4/s4.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single4/s4.5.jpg">
							<div class="thumb-image"> <img src="imagessingle/single4/s4.5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single4/s4.6.jpg">
							<div class="thumb-image"> <img src="imagessingle/single4/s4.6.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
							<li data-thumb="imagessingle/single4/s4.7.jpg">
							<div class="thumb-image"> <img src="imagessingle/single4/s4.7.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
					 <video controls>
                              <source src="imagessingle/single4/v4.mp4" type="video/mp4">
                                    </video>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						<h3>Темно-сірий шерстяний костюм</h3>
						<span>1600 ГРН.</span>
						<div class="clearfix"></div>
						<p>Жіночний. Ти в ньому це ти. Тканина трішки покусає(тому,що шерсть),але нас це не злякає.</p>
						<p></p>
					</div>
					...
					<div class="span span2">
						<p class="left">Довжна:</p>
						<p class="right">міді</p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="span span6">
						...
						<p class="right">спідниця має підкладку</p>
						<div class="clearfix"></div>
					</div>
					<div class="purchase">
						<a href="#"></a>
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=4" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Костюм має дві зав'язки які дають площину для творчості. Або бант або шарфік або просто так. Спідниця на резинці. Дає можливість трошки поправитися))) Тканина костюму тонка,спідниця має розову підкладку. </p>    
        </div>
			...
			<header>
				<h3 class="like text-center">Схожа Продукція</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single10.php"><img src="images/s10.1.jpg" alt="" /></a>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						...
						<a class="product_name" href="single3.php">Костюм.жилетка+спідния</a>
						<p><a class="item_add" href="single3.php"><span class="item_price">1450 грн.</span></a></p>
					</div>
					<div class="col-md-4 product simpleCart_shelfItem text-center">
