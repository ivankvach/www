...
<html>
<head>
<title>Ексклюзивний і авторський одяг | Плаття :: izhak.com.ua</title>
			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Плаття</span>&nbsp;</li>
					</ul>
						...
						<li>
							<a class="cbp-vm-image" href="single6.php">
								...
								<div class="product_image">
									...
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Вінтажне тмно-бірюзове плаття</p>
			...
			<h3 class="like text-center">Популярна колекція</h3>        			
				     <ul id="flexiselDemo3">
						...
						<li><a href="single3.php"><img src="images/s3.jpg" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single3.php">синій костюм</a>
						...
						<li><a href="single4.php"><img src="images/s4.jpg" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single4.php">Темно-сірий шерстянй костюм</a>
