...
<html>
<head>
<title>Ексклюзивний і авторський одяг | брошка листок :: izhak.com.ua</title>
	...
	<div class="container">
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="imagessingle/single14/s14.jpg">
								<div class="thumb-image"> <img src="imagessingle/single14/s14.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single14/s14.1.jpg">
								<div class="thumb-image"> <img src="imagessingle/single14/s14.1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single14/s14.2.jpg">
								<div class="thumb-image"> <img src="imagessingle/single14/s14.2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single14/s14.3.jpg">
								<div class="thumb-image"> <img src="imagessingle/single14/s14.3.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single14/s14.4.jpg">
								<div class="thumb-image"> <img src="imagessingle/single14/s14.4.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single14/s14.5.jpg">
								<div class="thumb-image"> <img src="imagessingle/single14/s14.5.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="imagessingle/single14/s14.6.jpg">
								<div class="thumb-image"> <img src="imagessingle/single14/s14.6.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>							
						</ul>
						</div>
				</div>
				<div class="col-md-7 dress-info">
					<div class="dress-name">
						...
						<span>250 ГРН.</span>
						<div class="clearfix"></div>
						<p>Її можна також використовувати як прикрасу для волосся і як брошку для верхнього одягу.Хто любить помітні аксесуари тоді це саме те що треба.</p>
						<p></p>
					</div>
					<div class="span span1">
						<p class="left">Матеріал:</p>
						<p class="right">вишивка+стрази</p>
						<div class="clearfix"></div>
					</div>
					<div class="span span4">
						<p class="left">Довжина:</p>
						<p class="right">8.0х8.0 см </p>
						<div class="clearfix"></div>
					</div>
					...
					<div class="purchase">
						...
						<div align="center"><form action="zapisi_tovara.php?idtovara=14" method="POST">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p class="tab-text">Її можна також використовувати як прикрасу для волосся і як брошку для верхнього одягу.Хто любить помітні аксесуари тоді це саме те що треба.</p>    
        </div>
			...
			<header>
				<h3 class="like text-center">Схожа Продукція</h3>   
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single11.php"><img src="images/s11.jpg" alt="" /></a>
						<a class="product_name" href="single11.php">етно намисто з монетами</a>
						<p><a class="item_add" href="single11.php"><span class="item_price">900 грн.</span></a></p>
					</div>
					<div class="col-md-4 product simpleCart_shelfItem text-center">
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single12.php"><img src="images/s12.jpg" alt="" /></a>
						<a class="product_name" href="single12.php">етно браслет з монетами</a>
						<p><a class="item_add" href="single12.php"><span class="item_price">320 грн.</span></a></p>
					</div>
					<div class="clearfix"></div>
				   </div>
				   </div>
